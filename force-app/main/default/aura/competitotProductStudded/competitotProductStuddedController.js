...
helper.getCompNamePickList(component, event, helper,'Stone_Quality_Physical_analysis__c'); 
       ...
       // helper.getCompNamePickList(component, event, helper,'City__c');
        ...
        helper.getCompNamePickList(component, event, helper,'Setting_Type_PA__c');
        ...
        helper.getCompNamePickList(component, event, helper,'Plating_Competitor_Billing__c');
    ...
    handlechange : function(component, event, helper){
        ...
        var weightcarat= component.get("v.CompetitorProduct");
        //alert("input is "+weightcarat.Weight_in_Carat_Competitor_Billing__c);
        weightcarat.Stone_price_Competitor__c = weightcarat.Weight_in_Carat_Competitor_Billing__c * weightcarat.Stone_Rate_per_Carat_Competitor__c;
        component.set("v.CompetitorProduct",weightcarat);
    },
    
    cancel : function(component, event, helper){
        var eUrl= $A.get("e.force:navigateToURL"); 
        eUrl.setParams({ "url": 'https://titanlightningapps.lightning.force.com/lightning/o/Competitor_Product_Jew__c/list?filterName=Recent' }); 
        eUrl.fire();
    },
