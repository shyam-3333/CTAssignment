({
    getCompNamePickList : function(component, event, helper,fieldName) {
        debugger;
        if(fieldName == 'Stone_Quality_Physical_analysis__c'){
        ...
        action.setCallback(this,function(response){
            ...
            if(state === "SUCCESS")
            {
                ...
                /*else if(fieldName == 'Competitor_name__c'){                    
                                        ...
                                        component.set("v.purchaseDepPickList",pickVal);
                                            ...
                                            component.set("v.colorOfMetalPickList",pickVal);
                                                ...
                                                component.set("v.purityPickList",pickVal);
                                                    ...
                                                    else if(fieldName == 'Stone_Quality_Competitor_Billing__c'){
                                                        component.set("v.stoneQualityPickList",pickVal);
                                                    }
                                                        else if(fieldName == 'Colour__c'){
                                                            component.set("v.colorPickList",pickVal);
                                                        }
                                                            else if(fieldName == 'Setting_Type_Competitor_Billling__c'){
                                                                component.set("v.settingTypeBill",pickVal);
                                                            }
                                                                    ...
                                                                    component.set("v.settingTypePA",pickVal);
                                                                        ...
                                                                        component.set("v.attachmentPickList",pickVal);
                                                                            ...
                                                                            component.set("v.finishBillingList",pickVal);
                                                                                ...
                                                                                else if(fieldName == 'Plating_Competitor_Billing__c'){
                                                                                    component.set("v.platingBillingList",pickVal);
                                                                                }
                                                                                    else if(fieldName == 'Stone_Detail__c'){
                                                                                        component.set("v.stoneDetailPickList2",pickVal);
                                                                                    }
                                                                                        else if(fieldName == 'Stone_Quality_Physical_analysis__c'){
                                                                                            debugger;
                                                                                            component.set("v.stoneQualityPickList2",pickVal);
                                                                                        }
    ...
    saveRecordHelper : function(component, event, helper){
        ...
        finalRec.Stone_Rate_per_Carat_Conclusion__c = JSON.stringify( finalRec.Stone_Rate_per_Carat_Equalent_at_Tanishq__c - finalRec.Stone_Rate_per_Carat_Competitor__c ) ;
    ...
    updateRecord : function(component,event,helper){
        ...
        rec.Stone_Rate_per_Carat_Conclusion__c = JSON.stringify( rec.Stone_Rate_per_Carat_Equalent_at_Tanishq__c - rec.Stone_Rate_per_Carat_Competitor__c ) ;
