({
    ...
    saveProdInfoData : function(component,event,helper) {
        ...
        if(component.get("v.constructRefNo") != undefined && component.get("v.constructRefNo") != ''){
            var constructionId = component.get("v.constructRefNo").Id;
        }
        //var constructionId = component.get("v.constructRefNo");
        //alert("-----constructionId--------"+constructionId);
        ...
        var data={'sobjectType': 'QC_Access_Component__c',
                  ...
                  'Construction_Refer_Number__c' : constructionId,
