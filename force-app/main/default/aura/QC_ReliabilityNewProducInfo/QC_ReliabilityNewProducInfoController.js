({
     doInit : function(component,event,helper){
         //alert('coming in reInit:::');
         debugger;
      	 var sampleCategory= component.get("v.childSampleCategory");
        //alert('------sampleCategory------'+sampleCategory);
         var reportRefId = component.get("v.referenceComponentNo").Id;
          //alert('sampleCategory::'+sampleCategory +'###'+'reportRefId:: '+reportRefId);
        if((sampleCategory !=undefined && sampleCategory !='') && (reportRefId !=undefined && reportRefId !='')){
            helper.fetchReSubmissionData (component,event,helper);
        }  
    },
    ...
    fetchVerdStatReliab :function(component, event, helper){
