...
import fetchLookupData from '@salesforce/apex/ProposalToolLookupComponentController.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/ProposalToolLookupComponentController.fetchDefaultRecord';

const DELAY = 300;


export default class ProposalToolOpportunityLookupComponent extends LightningElement {
